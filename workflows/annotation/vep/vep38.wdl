...
task vep_annotation {
    ...
    command {
        vep \
        -i ${snp_result} --cache --dir_cache /home/vep/.vep --flag_pick_allele --sift b --polyphen b --gene_phenotype --af --uniprot --symbol --protein --pubmed --biotype --ccds --check_existing --canonical --plugin Condel,/home/vep/.vep/Plugins/config/Condel/config,b --tab --output_file ${result_name}.gz --compress_output gzip --fork ${num_forks}     
    }
...
task vep_filter_important {
    ...
    command {
        filter_vep -i ${full_annotation} --gz -output_file ${filter_name} --filter "PHENO and PICK = 1"
    }
